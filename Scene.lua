...
function Scene:Start()
  ...
  AudioManager.CreateSound("Music", "Resources/Music/ForestFollies.mp3", true, true, "stream");
  ...
  self.Sky:Create("Resources/Textures/SpudSky.png", WindowSize.x/2, WindowSize.y/2 - 90);
